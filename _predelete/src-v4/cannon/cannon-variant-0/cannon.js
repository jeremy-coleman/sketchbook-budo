...
function Shape(options) {
  ...
  this.collisionFilterMask =
    options.collisionFilterMask !== undefined ? options.collisionFilterMask : -1
...
Shape.prototype.updateBoundingSphereRadius = function () {
  throw (
    "computeBoundingSphereRadius() not implemented for shape type " + this.type
  )
}
...
GridBroadphase.prototype.collisionPairs = function (world, pairs1, pairs2) {
  ...
  var binRadius =
    Math.sqrt(binsizeX * binsizeX + binsizeY * binsizeY + binsizeZ * binsizeZ) *
    0.5
...
function ConeTwistConstraint(bodyA, bodyB, options) {
  ...
  this.twistAngle =
    typeof options.twistAngle !== "undefined" ? options.twistAngle : 0
  c.maxForce = 0
  c.minForce = -maxForce
  t.maxForce = 0
  t.minForce = -maxForce
...
JacobianElement.prototype.multiplyElement = function (element) {
  return (
    element.spatial.dot(this.spatial) + element.rotational.dot(this.rotational)
  )
}
...
function Body(options) {
  ...
  this.sleepSpeedLimit =
    typeof options.sleepSpeedLimit !== "undefined"
      ...
      : 0.03
  this.sleepTimeLimit =
    typeof options.sleepTimeLimit !== "undefined" ? options.sleepTimeLimit : 1
  ...
  this.fixedRotation =
    typeof options.fixedRotation !== "undefined" ? options.fixedRotation : false
  this.angularDamping =
...
function RaycastVehicle(options) {
  ...
  this.world = null
  this.indexRightAxis =
    typeof options.indexRightAxis !== "undefined" ? options.indexRightAxis : 1
...
function World(options) {
  ...
  this.quatNormalizeFast =
    options.quatNormalizeFast !== undefined ? options.quatNormalizeFast : false
  this.time = 0.0
