...
class CannonDebugger {
  ...
  world: World
  _meshes: any[]
  _boxMaterial: THREE.MeshBasicMaterial
  _triMaterial: THREE.MeshBasicMaterial
  _sphereMaterial: THREE.MeshBasicMaterial
  ...
  constructor(scene: Scene, world: World, options: {}) {
    options = options || {}
...
export type CannonDebugRenderer = CannonDebugger;

export function CannonDebugRenderer(scene: Scene, world: World, options: {}) {
  return new CannonDebugger(scene, world, options)
}
